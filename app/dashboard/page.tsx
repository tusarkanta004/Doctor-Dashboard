...
export default function Dashboard() {
  ...
  return (
    <div className="p-5">
      {/* Topbar */}
      <div className="bg-white mb-6 p-5 rounded-2xl flex justify-between items-center shadow-md">
      ...
      <section className="flex gap-5 max-h-[calc(100vh-180px)] overflow-hidden">
              ...
              <div className="bg-blue-50 p-4 rounded-lg shadow-sm">
                ...
                <ul className="list-disc list-inside text-gray-700">
                  {selectedPatient.medicalHistory.map((entry, index) => (
                    <li key={index}>{entry.notes} – {entry.year}</li>
                  ))}
                </ul>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg shadow-sm">
        ...
        <div className="bg-white p-5 rounded-xl shadow-md w-[400px] flex-shrink-0 overflow-y-auto max-h-[calc(100vh-180px)]">
          {selectedPatient ? (
            ...
            <p className="text-gray-500 text-center">Select a patient to create a prescription.</p>
          )}
        </div>
      </section>
    </div>
